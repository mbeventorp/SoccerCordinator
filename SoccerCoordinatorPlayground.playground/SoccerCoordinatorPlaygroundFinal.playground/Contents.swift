...
for sharksPlayer in sharks {
    print("Dear, \(sharksPlayer["guardians"]as! String). \(sharksPlayer["name"]as! String) have been selected to the Sharks. The Sharks first practice is March 17, 3 pm. / Headcoach")
}

for raptorsPlayer in raptors {
    print("Dear, \(raptorsPlayer["guardians"] as! String). \(raptorsPlayer["name"] as! String) have been selected to the Raptors. The Raptors first practice is March 18, 1 pm. / Headcoach" )
}
